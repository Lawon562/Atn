...
namespace BAEKJOON
{
    class Level2
    {
        ...
        public void Q1330()
        {
            ...
            /*
            if (num[0] > num[1]) res = ">";
            else if (num[0] < num[1]) res = "<";
            else res = "==";
            */
            res = (num[0]>num[1]) ? ">" : (num[0]<num[1])? "<" : "==";
        ...
        public void Q2753()
        {
            ...
            Console.WriteLine(DateTime.IsLeapYear(year) ? 1 : 0);
        }
        ...
        public void Q2884()
        {
            DateTime time = DateTime.ParseExact(Console.ReadLine(), "H m", null).AddMinutes(-45);
        ...
        public void Q2525()
        {
            DateTime time = DateTime.ParseExact(Console.ReadLine(), "H m", null).AddMinutes(int.Parse(Console.ReadLine()));
            Console.WriteLine($"{time.Hour} {time.Minute}");
        }
        ...
        public void Q2480()
        {
            ...
            Array.Sort(dice);
            Console.WriteLine((dice[0] == dice[1]) ? (dice[1] == dice[2]) ? 10000 + dice[0] * 1000 : 1000 + dice[0] * 100 : (dice[1]==dice[2]) ? 1000+dice[1]*100 : dice[2] * 100);
        }
    }
}
